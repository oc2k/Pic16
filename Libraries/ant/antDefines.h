...
//////////////////////////////////////////////
#define DEFAULT_CHANNEL_MESSAGE_FREQUENCY          ((ULONG) 4) //((ULONG)4) default
...
// Additional Event5 Parts
#define EVENT_CHANNAL_OPEN_E5                      ((UCHAR)0xE1)           // Receive Open channal commend Message ID correct RESPONDE
//->
#define EVENT_RESPONSE_INITIAL_E5                  ((UCHAR)0xE5)           // Event code initial
#define EVENT_NO_ANT_RTS_E5                        ((UCHAR)0xE6)           // The Ant RTS no agree
#define EVENT_NO_RESPONSE_E5                       ((UCHAR)0xE7)           // Ant Message no response Event (E5)
#define EVENT_INVALID_HEADER_E5                    ((UCHAR)0xE8)           // Receive Header isnot 0xA5
#define EVENT_NO_EXPECTED_ID_E5                    ((UCHAR)0xE9)           // Receive Message ID isnot expected ID (EXPECTED ID: antMsgRESP.respID)
//#define EVENT_RESPONSE_IN_PROGRESS                 ((UCHAR)0xE9)           // To receive the response from ANT ready to process
//#define EVENT_DETECT_EXTRA_MESSAGE                 ((UCHAR)0xEA)           // To receive the message from ANT ready in extra
...
//*************************************************************
#ifndef AntDefines_H_isr
#define AntDefines_H_isr
#endif

//************************************************************* 
// Timing process in osSysClock, e.g.: #define SciSysclkTmr1() __clkSciPcMsgHmsCountdown();
//************************************************************* 
#ifndef AntDefines_H_sysClk
#define AntDefines_H_sysClk
#endif
