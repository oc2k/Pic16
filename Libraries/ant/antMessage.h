...
//        CS    is the 1 byte Checksum of the message
/////////////////////////////////////////////////////////////////////////////
...
#define MESG_FRAME_SIZE_E5                (MESG_SYNC_SIZE + MESG_CHECKSUM_SIZE)
...
// Message ID's
//////////////////////////////////////////////
#define MESG_CLEAN_ID                     ((UCHAR)0x00)
...
#define MESG_RESPONSE_STARTUP_ID          ((UCHAR)0x6F)
#define MESG_NO_RESPONSE_ID_E5            ((UCHAR)0x00)  /// Extra Message ID as E5 (see antDefines.h)
...
#define MESG_DEEP_SLEEP_ID				  ((UCHAR)0xC5)
...
#define MESG_DEEP_SLEEP_SIZE			  ((UCHAR)1)
...
//*************************************************************
#ifndef AntMessage_H_isr
#define AntMessage_H_isr
#endif

//************************************************************* 
// Timing process in osSysClock, e.g.: #define SciSysclkTmr1() __clkSciPcMsgHmsCountdown();
//************************************************************* 
#ifndef AntMessage_H_sysClk
#define AntMessage_H_sysClk
#endif
